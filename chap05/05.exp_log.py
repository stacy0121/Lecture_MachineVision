...
v3 = np.array([[1, 2, 3]], np.float32)       # 1행, 3열 행벡터
...
## 행렬 정보 출력 - OpenCV 결과는 행렬로 반환됨 - 행벡터는 열백터로 반환됨
print("[v1_exp] 자료형: %s 형태: %s" % (type(v1_exp), v1_exp.shape))   # 행 벡터 인수의 결과
# print("%s" % v1_exp)
print("[v2_exp] 자료형: %s 형태: %s" % (type(v2_exp), v2_exp.shape))
print("[v3_exp] 자료형: %s 형태: %s" % (type(v3_exp), v3_exp.shape))

## 열벡터를 1행에 출력하는 예시 - 행벡터로 변환
print("[log] =", log.T)
