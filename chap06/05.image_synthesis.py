...
image1 = cv2.imread("images_ch06/hsv.jpg", cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread("images_ch06/hsvCub.jpg", cv2.IMREAD_GRAYSCALE)
...
for t in titles: cv2.imread(t, eval(t))
cv2.waitKey()