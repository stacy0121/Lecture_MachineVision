...
image8 = cv2.imread("ch04_images/read_color.jpg", cv2.IMREAD_COLOR)
...
cv2.imwrite("ch04_images/write_test_16.tif", image16)
cv2.imwrite("ch04_images/write_test_32.tif", image32)

cv2.imshow('image16', image16)
cv2.imshow('imgae32', (image32*255).astype('uint8'))
cv2.waitKey()